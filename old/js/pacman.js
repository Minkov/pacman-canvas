...
window.onload = function() {
    ...
    function areColliding(obj1, obj2) {
        ...
        return (((sizes1.left <= sizes2.left && sizes2.left <= sizes1.right) || (sizes1.left <= sizes2.right && sizes2.right <= sizes1.right)) &&
            ...
            (((sizes1.top <= sizes2.top && sizes2.bottom < sizes1.bottom) || (sizes2.top <= sizes1.top && sizes1.bottom < sizes2.bottom)) &&
                ((sizes1.left <= sizes2.left && sizes2.right < sizes1.right) || (sizes2.left <= sizes1.left && sizes1.right < sizes2.right)));
    }
    ...
    function step() {
        ...
        for (var k = 0; k < pacman.size; k += 1) {
            if (areCollidingWithObstracle) {
                break;
            }

            nextPosition = {
                "x": pacman.x + dirs[dir].x * speed * k,
                "y": pacman.y + dirs[dir].y * speed * k,
                "size": pacman.size
            };
